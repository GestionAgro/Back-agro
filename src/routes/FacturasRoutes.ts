...
import { listarFactura,crearFactura,obtenerFacturaPorNumero,actualizarFactura,borrarFactura,obtenerFactura,asociarRemitoAFactura,reporteMensualFactura } from "../controller/FacturaController";
import { verificarTokenFirebase } from "../middleware/VerificacionToke";

const router = Router();

router.get("/", listarFactura);
router.get("/reporte/total-por-mes", reporteMensualFactura);
